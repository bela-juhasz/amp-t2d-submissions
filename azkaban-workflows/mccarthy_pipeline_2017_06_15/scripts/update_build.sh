...
#This version, outdir is specified, so that all temp files, etc, are localized
#to the output directory, not just the final result
...
#Plink files
temp_prefix=$outdir/TEMP_FILE_XX72262628_
temp1=$temp_prefix"1"
temp2=$temp_prefix"2"
temp3=$temp_prefix"3"
...
plink --noweb --allow-no-sex --bfile $temp3 --extract $pos_file --make-bed --out $outdir/aligned
